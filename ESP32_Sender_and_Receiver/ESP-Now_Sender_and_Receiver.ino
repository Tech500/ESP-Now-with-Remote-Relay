...
#define TZ "EST+5EDT,M3.2.0/2,M11.1.0/2"   //https://en.wikipedia.org/wiki/List_of_tz_database_time_zones
...
EMailSender emailSend("##############@gmail.com", "###################");   //Edit with your gmail email address and authennitcation
...
void sendRequestURL()  //Triggers cellphone SMS alert and email alert.
{
     ...
     if(textRequest == 1)
     {
          ...
          EMailSender::Response resp = emailSend.send("##############@vtext.com", message);  //Edit with your 10 digit dellphone number
          emailSend.send("############@gmail.com", message);   //Edit with gmail email address
